...
import { LayoutDashboard, ShoppingBag, ChefHat, ScrollText, Settings, Package, Cookie, Folder, Layers } from 'lucide-react';
...
const AdminLayout = ({ children, title }) => {
  const navItems = [
    ...
    { icon: <Layers size={20} />, label: 'Модификации', path: '/admin/modifiers' },
