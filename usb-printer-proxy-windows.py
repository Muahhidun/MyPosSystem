...
# ==================== НАСТРОЙКИ ====================
# Укажи точные имена принтеров из Windows (см. "Устройства и принтеры")
RECEIPT_PRINTER = 'Касса'  # Принтер чеков (PrinterPOS-80 на порту USB001)
LABEL_PRINTER = 'ИЗМЕНИ_МЕНЯ'    # Принтер этикеток - НАЙДИ ВТОРОЙ ПРИНТЕР!

# Порты (разные порты для разных принтеров)
RECEIPT_PORT = 9100  # Для чеков
LABEL_PORT = 9101    # Для этикеток
# ===================================================
